...
public class ASD {
  ...
  // Concrete class for Expression: Min case
  static public class MinExpression extends Expression {
    Expression left;
    Expression right;
    ...
    public RetExpression toIR() throws TypeException {
      ...
      // new min instruction result = left - right
      Llvm.Instruction min = new Llvm.Sub(leftRet.type.toLlvmType(), leftRet.result, rightRet.result, result);

      // append this instruction
      leftRet.ir.appendCode(min);
